...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ServiceDesk', fields ['name']
        db.create_unique('syrup_servicedesk', ['name'])

        # Adding unique constraint on 'Term', fields ['code']
        db.create_unique('syrup_term', ['code'])

        # Adding unique constraint on 'Course', fields ['code']
        db.create_unique('syrup_course', ['code'])

        # Adding unique constraint on 'Config', fields ['name']
        db.create_unique('syrup_config', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ServiceDesk', fields ['name']
        db.delete_unique('syrup_servicedesk', ['name'])

        # Removing unique constraint on 'Term', fields ['code']
        db.delete_unique('syrup_term', ['code'])

        # Removing unique constraint on 'Course', fields ['code']
        db.delete_unique('syrup_course', ['code'])

        # Removing unique constraint on 'Config', fields ['name']
        db.delete_unique('syrup_config', ['name'])
