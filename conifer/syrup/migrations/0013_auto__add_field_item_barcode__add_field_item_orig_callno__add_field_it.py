...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('syrup_item', 'barcode', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)

        # Adding field 'Item.orig_callno'
        db.add_column('syrup_item', 'orig_callno', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Item.evergreen_update'
        db.add_column('syrup_item', 'evergreen_update', self.gf('django.db.models.fields.CharField')(default='One', max_length=4), keep_default=False)

        # Adding field 'Item.circ_modifier'
        db.add_column('syrup_item', 'circ_modifier', self.gf('django.db.models.fields.CharField')(default='RSV2', max_length=10), keep_default=False)

        # Adding field 'Item.circ_desk'
        db.add_column('syrup_item', 'circ_desk', self.gf('django.db.models.fields.CharField')(default='631', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.barcode'
        db.delete_column('syrup_item', 'barcode')

        # Deleting field 'Item.orig_callno'
        db.delete_column('syrup_item', 'orig_callno')

        # Deleting field 'Item.evergreen_update'
        db.delete_column('syrup_item', 'evergreen_update')

        # Deleting field 'Item.circ_modifier'
        db.delete_column('syrup_item', 'circ_modifier')

        # Deleting field 'Item.circ_desk'
        db.delete_column('syrup_item', 'circ_desk')
    ...
    models = {
        ...
        'syrup.item': {
            ...
            'circ_desk': ('django.db.models.fields.CharField', [], {'default': "'631'", 'max_length': '5'}),
            'circ_modifier': ('django.db.models.fields.CharField', [], {'default': "'RSV2'", 'max_length': '10'}),
            'copyright_status': ('django.db.models.fields.CharField', [], {'default': "'UK'", 'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'evergreen_update': ('django.db.models.fields.CharField', [], {'default': "'One'", 'max_length': '4'}),
        ...
        'syrup.site': {
            ...
            'access': ('django.db.models.fields.CharField', [], {'default': "'MEMBR'", 'max_length': '5'}),
