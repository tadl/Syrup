...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for item in orm.Item.objects.filter(copyright_status='AV'):
            item.copyright_status = 'UK' # unknown
            item.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        # nothing we can do going backwards; AV->UK is a destructive change.
