...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.copyright_status'
        db.add_column('syrup_item', 'copyright_status', self.gf('django.db.models.fields.CharField')(default='UK', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.copyright_status'
        db.delete_column('syrup_item', 'copyright_status')
