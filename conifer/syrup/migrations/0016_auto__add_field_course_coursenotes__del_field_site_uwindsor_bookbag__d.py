...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.coursenotes'
        db.add_column('syrup_course', 'coursenotes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Site.uwindsor_bookbag'
        db.delete_column('syrup_site', 'uwindsor_bookbag')

        # Deleting field 'Site.uwindsor_eres'
        db.delete_column('syrup_site', 'uwindsor_eres')

        # Adding field 'Site.sitenotes'
        db.add_column('syrup_site', 'sitenotes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Item.itemnotes'
        db.add_column('syrup_item', 'itemnotes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.coursenotes'
        db.delete_column('syrup_course', 'coursenotes')

        # Adding field 'Site.uwindsor_bookbag'
        db.add_column('syrup_site', 'uwindsor_bookbag', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True), keep_default=False)

        # Adding field 'Site.uwindsor_eres'
        db.add_column('syrup_site', 'uwindsor_eres', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True), keep_default=False)

        # Deleting field 'Site.sitenotes'
        db.delete_column('syrup_site', 'sitenotes')

        # Deleting field 'Item.itemnotes'
        db.delete_column('syrup_item', 'itemnotes')
