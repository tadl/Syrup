...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.start_term'
        db.add_column('syrup_site', 'start_term', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='start_term', to=orm['syrup.Term']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Site.start_term'
        db.delete_column('syrup_site', 'start_term_id')

        # Deleting field 'Site.end_term'
        db.delete_column('syrup_site', 'end_term_id')
