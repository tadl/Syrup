...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.fileobj_origname'
        db.add_column('syrup_item', 'fileobj_origname', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.fileobj_origname'
        db.delete_column('syrup_item', 'fileobj_origname')
