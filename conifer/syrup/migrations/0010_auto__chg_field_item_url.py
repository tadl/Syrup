...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('syrup_item', 'url', self.gf('django.db.models.fields.URLField')(max_length=2048, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Item.url'
        db.alter_column('syrup_item', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))
