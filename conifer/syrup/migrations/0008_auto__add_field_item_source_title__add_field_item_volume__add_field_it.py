...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.source_title'
        db.add_column('syrup_item', 'source_title', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=8192, null=True, blank=True), keep_default=False)

        # Adding field 'Item.volume'
        db.add_column('syrup_item', 'volume', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Item.issue'
        db.add_column('syrup_item', 'issue', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Item.pages'
        db.add_column('syrup_item', 'pages', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Item.isbn'
        db.add_column('syrup_item', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.source_title'
        db.delete_column('syrup_item', 'source_title')

        # Deleting field 'Item.volume'
        db.delete_column('syrup_item', 'volume')

        # Deleting field 'Item.issue'
        db.delete_column('syrup_item', 'issue')

        # Deleting field 'Item.pages'
        db.delete_column('syrup_item', 'pages')

        # Deleting field 'Item.isbn'
        db.delete_column('syrup_item', 'isbn')
